...
- **CI/CD**: Deploy via Github action
...
- Test with real HTTP clients if the server is publicly available and does not need authentication
- Test with mocks of the external API if it is not avilable. Mocks should be generated by **Wiremock**
